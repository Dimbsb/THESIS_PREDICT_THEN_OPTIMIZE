...
from EMS_BB_BFS import solve_instance
from EMS_MODEL import load_data as ems_load_data
...
if __name__ == "__main__":
    ...
    house_scenarios = {
        "HOUSE1": {"train": ["HOUSE1.1", "HOUSE1.2"], "test": "HOUSE1"},
        "HOUSE2": {"train": ["HOUSE2.1", "HOUSE2.2"], "test": "HOUSE2"},
        "HOUSE3": {"train": ["HOUSE3.1", "HOUSE3.2"], "test": "HOUSE3"}
        }
...
# PERFECT INFORMATION
            ...
            print("-" * 40)
            print(f"FULL MODEL RESULTS [{location}] - PERFECT INFORMATION")
            print("-" * 40)
...
# FORECASTED INFORMATION
            ...
            for noise in noise_levels:
                ...
                print(f"\n{forecast_line}")
                print("-" * 40)
                print(f"FULL MODEL RESULTS [{location}] - FORECASTED INFORMATION - Noise={noise*100:.0f}%")
                print("-" * 40)
...
# ΑΠΟΤΕΛΕΣΜΑΤΑ
            ...
            print("\n" + "=" * 60)
            print(f"Difference Summary [{location}]")
            print("=" * 60)
            for noise in noise_levels:
                cost_gap = noise_gaps.get(noise)
                if cost_gap is None:
                    print(f"Predicted - Perfect at Noise={noise*100:.0f}%: N/A")
                else:
                    print(f"Predicted - Perfect at Noise={noise*100:.0f}%: {cost_gap:,.2f} CHF")
            print("=" * 60 + "\n")
